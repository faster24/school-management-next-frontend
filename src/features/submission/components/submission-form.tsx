...
export default function SubmissionForm({
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        formData.append('assignment_id', assgnmentId); // Use assgnmentId directly as it's a string prop
        formData.append('submitted_at', values.submitted_at);
        formData.append('student_id', studentId.toString()); // Convert number to string for FormData

        if (values.file instanceof File) {
            formData.append('file', values.file, values.file.name);
        }

        const isSuccess = await createSubmission(formData);
